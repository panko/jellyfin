...
namespace Jellyfin.Server.Implementations.Tests.Library
{
    ...
    public class MixedLibraryResolverTests
    {
        ...
        [Theory]
        [InlineData("/media/30.Years.After.2026.1080p.MA.WEBRip.DDP5.1.Atmos.x264.HUN-PULSAR", "quasar-30.years.after.2026.1080p.webrip.ma.mkv")]
        [InlineData("/media/3000.Women.And.Me.The.Crimson.Tide.Story.2027.HUN.WEB-DL.1080p.H.264-HORDE", "3000.Women.And.Me.The.Crimson.Tide.Story.2027.HUN.WEB-DL.1080p.H.264-HORDE.mkv")]
        [InlineData("/media/Canadian Maniac 2000 1080p CEE Blu-Ray ReMuX AVC DTS-HD 5.1-HQZONE", "Canadian Maniac 2000 1080p CEE Blu-Ray ReMuX AVC DTS-HD 5.1-HQZONE.mkv")]
        ...
        public void SeriesResolver_LibraryRootWithNumberedMovieFolders_DoesNotResolveAsSeries()
        {
            ...
            var args = ArgsForDirectory(
                ...
                new Folder(),
                CollectionType.mixed,
                new FileSystemMetadata { FullName = "/media/3000.Women.And.Me.The.Crimson.Tide.Story.2027.HUN.WEB-DL.1080p.H.264-HORDE", IsDirectory = true },
                new FileSystemMetadata { FullName = "/media/30.Years.After.2026.1080p.MA.WEBRip.DDP5.1.Atmos.x264.HUN-PULSAR", IsDirectory = true },
                new FileSystemMetadata { FullName = "/media/Canadian Maniac 2000 1080p CEE Blu-Ray ReMuX AVC DTS-HD 5.1-HQZONE", IsDirectory = true });
        ...
        public void EpisodeResolver_FlatEpisodeFileInMixedLibrary_ResolvesToEpisode()
        {
                ...
                null)
            {
                ...
                {
                    FullName = "/media/Starlight.S02E01.1080p.NOVA.WEB-DL.DDP5.1.Atmos.DV.HDR.H265.HUN.ENG-Z9R.mkv"
                }
            };
        ...
        public void EpisodeResolver_MovieFileInMixedLibrary_DoesNotResolveToEpisode()
        {
                ...
                null)
            {
                ...
                FileInfo = new FileSystemMetadata
                {
                    FullName = "/media/quasar-30.years.after.2026.1080p.webrip.ma.mkv"
                }
            };
        ...
        {
            var resolver = new MovieResolver(Mock.Of<IImageProcessor>(), Mock.Of<ILogger<MovieResolver>>(), _namingOptions, Mock.Of<IDirectoryService>(), _videoListResolver);
            var parent = new Series { Name = "Starlight" };
            var files = new List<FileSystemMetadata>
            {
                new FileSystemMetadata { FullName = "/media/Starlight.S02/Starlight.S02E01.1080p.mkv", Name = "Starlight.S02E01.1080p.mkv" },
                new FileSystemMetadata { FullName = "/media/Starlight.S02/Starlight.S02E02.1080p.mkv", Name = "Starlight.S02E02.1080p.mkv" }
            };
        ...
        public void MovieResolver_ResolveMultiple_MovieFilesInMixedLibrary_AreClaimedAsMovies()
        {
            ...
            var files = new List<FileSystemMetadata>
            {
                new FileSystemMetadata { FullName = "/media/quasar-30.years.after.2026.1080p.webrip.ma.mkv", Name = "quasar-30.years.after.2026.1080p.webrip.ma.mkv" },
                new FileSystemMetadata { FullName = "/media/Starlight.S02E01.1080p.mkv", Name = "Starlight.S02E01.1080p.mkv" }
            };
            ...
            Assert.Contains(result.ExtraFiles, f => string.Equals(f.FullName, "/media/Starlight.S02E01.1080p.mkv", StringComparison.Ordinal));
        }
    }
}
